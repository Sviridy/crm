...
urlpatterns = [
    ...
    path('employee_search', EmployeeSearch.as_view(), name='employee_search'),
    ...
    path('tasks_search', TasksSearch.as_view(), name='tasks_search'),
    ...
    path('company_search', CompanySearch.as_view(), name='company_search'),
    ...
    path('contacts_search', ContactsSearch.as_view(), name='contacts_search'),
    ...
    path('payment_search', PaymentSearch.as_view(), name='payment_search'),
    ...
    path('proposal_search', ProposalSearch.as_view(), name='proposal_search'),
    ...
    path('deal_search', DealSearch.as_view(), name='deal_search'),
